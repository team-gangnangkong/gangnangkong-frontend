      ...
      <div class="card-content">
        <div class="card-title-row">
          ...
          <span class="card-like">
            <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
              ...
              <path d="M9 11l4.2-7.2a2 2 0 0 1 3.7.9v5.3h3a2 2 0 0 1 2 2l-2 8a2 2 0 0 1-2 1.5H9V11Z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"/>
            </svg>
            <span>${likeCount}</span>
          </span>
          <span class="card-comment">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
              <path d="M9.49968 1.58301C13.8721 1.58301 17.4163 5.1273 17.4163 9.49967..." fill="#F87171"/>
            </svg>
        ...
        <div class="card-desc">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none">
            <path d="M12.2427 3.09087C13.3443 4.19229... " fill="#9CA3AF"/>
          </svg>
